function ContributingFactorDropdown({ placeholder = "Select Contributing Factor", ...props }) {
  return (
    <div>
      <label htmlFor="contributing-factor" className="block text-sm font-medium text-gray-700 mb-2">
        Contributing Factor
      </label>
      <select
...
export default ContributingFactorDropdown
